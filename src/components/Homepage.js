          ...
          <div className="container-fluid">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img
                  src="https://images.hindustantimes.com/auto/img/2022/04/06/600x338/UKRAINE-CRISIS-RUSSIA-VOLKSWAGEN-21_1649244262180_1649244279457.JPG"
                ...
                <div className="carousel-caption d-none d-md-block">
                  <strong className="text-light">
                    MORE THAN 20000 CARS ARE REGISTERED WITH US
                  </strong>
                  <br></br>
                  <strong className="text-light">
                    YOU CAN SELL YOUR OLD CAR WITH US, GET REGISTERED AND PLACE
                    A REQUEST
                  </strong>
                </div>
              </div>
              <div className="carousel-item">
                <img
                  src="https://www.financialexpress.com/wp-content/uploads/2019/12/multi-brand-car-service-india.jpg"
                  className="d-block w-100"
                  height="500"
                  width="500"
                  alt="..."
                />
                <div className="carousel-caption d-none d-md-block">
                  <strong>GET YOUR OLD CAR SERVICED</strong>
                  <br></br>
                  <strong>
                    GET REGISTERED WITH US TO AVAIL AMAZING OFFERS
                  </strong>
                </div>
              </div>
              <div className="carousel-item">
                <img
                  src="https://149363333.v2.pressablecdn.com/wp-content/uploads/2021/12/CDS-blog-JanBlog1-1110x624.jpg"
                  className="d-block w-100"
                  width="500"
                  height="500"
                  alt="..."
                />
                <div className="carousel-caption d-none d-md-block">
                  <strong className="text-dark">WE VALUE CUSTOMER IDEAS</strong>
                  <br></br>
                  <strong className="text-dark">
                    CUSTOMERS SATISFACTION MATTERS THE MOST FOR US
                  </strong>
                </div>
              </div>
            </div>
          ...
          <div className="col">
            <div className="card" style={{ height: 550 }}>
              ...
              <div className="card-body">
                <strong className="card-title">Employee Login</strong>
                <br></br>
                <p className="card-text">
                  This component is meant for the employees to login<br></br>{" "}
                  customers can use the login option available in the navbar and
                  enjoy the advantages of being a customer in the automobile
                  company!!!!!
                </p>
                <button
            ...
            <div className="card" style={{ height: 550 }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  more on selected cars....Login now to chekout or register with
                  our company!!!
                </p>
            ...
            <div className="card" style={{ height: 550 }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  services <br></br> Avail free teflon coating for all the cars
                  registered with our company <br></br> Get free wheel
                  allignment for the first service of your car{" "}
                </p>
                <a href="/login" className="btn btn-primary mt-5">
                  login
                </a>
